...
const Sidebar = () => {
    ...
    return (
        <div className="sidenav">
                <div>
                    <a href={'/profile'} className={`sidenav-button ${currentPath === "/profile" ? "active" : ""}`}>
                    ...
                    <a href={'/events/public'} className={`sidenav-button ${currentPath === "/events/public" ? "active" : ""}`}>
                        <div className={"sidebar-tab-icon"}>
                    ...
                    <a href={'/events/private'} className={`sidenav-button ${currentPath === "/events/private" ? "active" : ""}`}>
                        <div className={"sidebar-tab-icon"}>
                    ...
                    <a href={'/users'} className={`sidenav-button ${currentPath === "/users" ? "active" : ""}`}>
                        <div className={"sidebar-tab-icon"}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"
